...
- **[LightningProx](https://github.com/unixlamadev-spec/lightningprox-mcp)** - AI gateway with Lightning Network micropayments. Agents pay per request (3-10 sats) using prepaid spend tokens. Supports Claude, GPT-4, and model discovery. No API keys needed.
- **[SolanaProx](https://github.com/solanaprox/mcp-server)** - AI gateway with Solana/USDC micropayments. Agents pay per request ($0.003) using Phantom wallet as identity. Supports Claude, GPT-4, and model discovery. No API keys needed.
- **[AIProx MCP](https://github.com/unixlamadev-spec/aiprox-mcp)** - Open agent registry MCP server. Discover agents by capability and payment rail. Bitcoin Lightning and Solana USDC support. No API keys needed.
- **[LPXPoly MCP](https://github.com/unixlamadev-spec/lpxpoly-mcp)** - AI Polymarket analysis with Lightning micropayments. Find edge opportunities and analyze markets. Pay per analysis in sats. No API keys needed.
